...
(function() {
  ...
  */
  /*
    Web Payment Form
  */
  var AfricanMobilePayout, AfricanMobileSale, Alipay, ApplePay, Argencard, Aura, Authorize, Authorize3d, Baloto, BancoDeOccidente, BancoDoBrasil, Bancomer, Bancontact, Blacklist, Boleto, Bradesco, Cabal, Cancel, Capture, Cash, CashU, Cencosud, Chargeback, ChargebackByDate, Config, CreateConsumer, Credit, Davivienda, DeleteToken, Detokenize, DisableConsumer, Efecty, Elo, EnableConsumer, Eps, FraudReport, FraudReportByDate, GetCards, GetTokenizedCard, GooglePay, IDebitPayin, IDebitPayout, Ideal, InitRecurringSale, InitRecurringSale3d, InstaDebitPayin, InstaDebitPayout, Itau, MethodContinue, Multibanco, MyBank, Naranja, Nativa, OnlineBankingPayin, OnlineBankingPayout, Oxxo, P24, PPRO, PagoFacil, PayPal, Payers, Payout, Paysafecard, Payu, Pix, Poli, PostFinance, Pse, Reconcile, ReconcileByDate, RecurringSale, Redpagos, Refund, Retrieval, RetrievalByDate, RetrieveConsumer, RussianMobilePayout, RussianMobileSale, Sale, Sale3d, Santander, SddInitRecurringSale, SddRecurringSale, SddRefund, SddSale, Sofort, TarjetaShopping, Tokenize, Transaction, TrustlySale, TrustlyWithdrawal, UpdateConsumer, UpdateToken, ValidateToken, Webpay, Wechat, WpfCreate, WpfReconcile;
