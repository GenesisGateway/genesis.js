...
(function() {
  ...
  */
  /*
    Web Payment Form
  */
  var AfricanMobilePayout, AfricanMobileSale, Alipay, ApplePay, Argencard, Aura, Authorize, Authorize3d, Baloto, BancoDeOccidente, BancoDoBrasil, Bancomer, Bancontact, BitpayPayout, BitpayRefund, BitpaySale, Blacklist, Boleto, Bradesco, Cabal, Cancel, Capture, Cash, CashU, Cencosud, Chargeback, ChargebackByDate, Config, CreateConsumer, CreatePayee, CreatePayeeAccount, Credit, Cryptogram, Davivienda, DeleteToken, Detokenize, DisableConsumer, Efecty, Elo, EnableConsumer, Eps, Fashioncheque, FraudReport, FraudReportByDate, FxRate, FxRates, FxSearchRate, FxTier, FxTiers, GetCards, GetTokenizedCard, GlobalPayout, GooglePay, IDebitPayin, IDebitPayout, Ideal, IncrementalAuthorize, InitRecurringSale, InitRecurringSale3d, InstaDebitPayin, InstaDebitPayout, InstallmentsFetch, InstallmentsShowDetails, Intersolve, Itau, KycCnpj, KycCpf, KycCreateConsumer, KycCreateTransaction, KycCreateVerification, KycDownloadDocument, KycMakeCall, KycUpdateCall, KycUpdateConsumer, KycUpdateTransaction, KycUploadDocument, KycVerificationRegister, KycVerificationRemoteIdentity, KycVerificationStatus, ListPayeeAccounts, MethodContinue, Multibanco, MyBank, Naranja, Nativa, Neosurf, OnlineBankingPayin, OnlineBankingPayout, Oxxo, P24, PPRO, PagoFacil, PartialReversal, PayPal, Payers, Payout, Paysafecard, Payu, Pix, Poli, PostFinance, ProcessedTransactions, ProcessedTransactionsByDate, ProcessedTransactionsByPostDate, Pse, Reconcile, ReconcileByDate, RecurringSale, Redpagos, Refund, Retrieval, RetrievalByDate, RetrieveConsumer, RetrievePayee, RetrievePayeeAccount, RussianMobilePayout, RussianMobileSale, Sale, Sale3d, Santander, ScaChecker, SctPayout, SddInitRecurringSale, SddRecurringSale, SddRefund, SddSale, Sofort, TarjetaShopping, Tcs, Tokenize, Transaction, TransferToPayout, TrustlySale, TrustlyWithdrawal, UpdateConsumer, UpdateToken, Upi, ValidateToken, Webpay, Wechat, WpfCreate, WpfReconcile;
  ...
  KycVerificationRemoteIdentity = require('./transactions/non_financial/kyc/verification/kyc_verification_remote_identity');
  ...
  */
  Transaction = class Transaction {
    ...
    */
    ...
    neosurf(params) {
      return new Neosurf(params, this.config);
    }
    ...
    */
    incremental_authorize(params) {
      return new IncrementalAuthorize(params, this.config);
    }
    ...
    */
    ...
    transfer_to_payout(params) {
      return new TransferToPayout(params, this.config);
    }

    global_payout(params) {
      return new GlobalPayout(params, this.config);
    }
    ...
    */
    ...
    sct_payout(params) {
      return new SctPayout(params, this.config);
    }

    upi(params) {
      return new Upi(params, this.config);
    }
    ...
    */
    partial_reversal(params) {
      return new PartialReversal(params, this.config);
    }
    ...
    */
    fashioncheque(params) {
      return new Fashioncheque(params, this.config);
    }

    intersolve(params) {
      return new Intersolve(params, this.config);
    }

    tcs(params) {
      return new Tcs(params, this.config);
    }
    ...
    */
    ...
    cryptogram(params) {
      return new Cryptogram(params, this.config);
    }
    ...
    */
    ...
    kyc_verification_remote_identity(params) {
      return new KycVerificationRemoteIdentity(params, this.config);
    }
    ...
    */
    bitpay_sale(params) {
      return new BitpaySale(params, this.config);
    }

    bitpay_refund(params) {
      return new BitpayRefund(params, this.config);
    }

    bitpay_payout(params) {
      return new BitpayPayout(params, this.config);
    }
    ...
    */
    create_payee(params) {
      return new CreatePayee(params, this.config);
    }

    retrieve_payee(params) {
      return new RetrievePayee(params, this.config);
    }

    create_payee_account(params) {
      return new CreatePayeeAccount(params, this.config);
    }

    retrieve_payee_account(params) {
      return new RetrievePayeeAccount(params, this.config);
    }

    list_payee_accounts(params) {
      return new ListPayeeAccounts(params, this.config);
    }
