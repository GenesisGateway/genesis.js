...
(function() {
  ...
  */
  /*
    Web Payment Form
  */
  var AccountVerification, Alipay, Authorize, Authorize3d, Avs, Blacklist, Cancel, Capture, Chargeback, ChargebackByDate, Credit, Earthport, FraudReport, FraudReportByDate, IDebitPayin, IDebitPayout, InitRecurringSale, InitRecurringSale3d, InstaDebitPayin, InstaDebitPayout, P24, PPRO, PaySecPayin, PaySecPayout, Payout, PaypalExpress, Paysafecard, Reconcile, ReconcileByDate, RecurringSale, Refund, Retrieval, RetrievalByDate, Sale, Sale3d, SddInitRecurringSale, SddRecurringSale, SddRefund, SddSale, Sofort, Transaction, TrustlySale, TrustlyWithdrawal, Wechat, WpfCreate, WpfReconcile;
  ...
  Transaction = class Transaction {
    ...
    */
    ...
    paypal_express(params) {
      return new PaypalExpress(params);
    }
