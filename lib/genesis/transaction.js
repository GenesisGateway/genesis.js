...
(function() {
  ...
  */
  /*
    Web Payment Form
  */
  var AfricanMobilePayout, AfricanMobileSale, Alipay, ApplePay, Argencard, Aura, Authorize, Authorize3d, Avs, Baloto, BancoDeOccidente, BancoDoBrasil, Bancomer, Bancontact, Blacklist, Boleto, Bradesco, Cabal, Cancel, Capture, Cash, CashU, Cencosud, Chargeback, ChargebackByDate, Config, Credit, Davivienda, Efecty, Elo, Eps, FraudReport, FraudReportByDate, GooglePay, IDebitPayin, IDebitPayout, Ideal, InitRecurringSale, InitRecurringSale3d, InstaDebitPayin, InstaDebitPayout, Itau, MethodContinue, Multibanco, MyBank, Naranja, Nativa, OnlineBankingPayin, OnlineBankingPayout, Oxxo, P24, PPRO, PagoFacil, PayPal, Payout, Paysafecard, Payu, Pix, Poli, PostFinance, Pse, Reconcile, ReconcileByDate, RecurringSale, Redpagos, Refund, Retrieval, RetrievalByDate, RussianMobilePayout, RussianMobileSale, Sale, Sale3d, Santander, SddInitRecurringSale, SddRecurringSale, SddRefund, SddSale, Sofort, TarjetaShopping, Transaction, TrustlySale, TrustlyWithdrawal, Webpay, Wechat, WpfCreate, WpfReconcile;
