...
(function() {
  ...
  Types = (function() {
    class Types {
      ...
      getWPFTypes() {
        return [this.constructor.AURA, this.constructor.ARGENCARD, this.constructor.AUTHORIZE, this.constructor.AUTHORIZE_3D, this.constructor.BANCONTACT, this.constructor.CABAL, this.constructor.CENCOSUD, this.constructor.ELO, this.constructor.SALE, this.constructor.SALE_3D, this.constructor.INIT_RECURRING_SALE, this.constructor.INIT_RECURRING_SALE_3D, this.constructor.CASHU, this.constructor.PAYSAFECARD, this.constructor.EZEEWALLET, this.constructor.PPRO, this.constructor.SOFORT, this.constructor.NETELLER, this.constructor.ABNIDEAL, this.constructor.WEBMONEY, this.constructor.POLI, this.constructor.INPAY, this.constructor.SDD_SALE, this.constructor.SDD_INIT_RECURRING_SALE, this.constructor.P24, this.constructor.TRUSTLY_SALE, this.constructor.TRUSTLY_WITHDRAWAL, this.constructor.CITADEL_PAYIN, this.constructor.INSTA_DEBIT_PAYIN, this.constructor.BANCOMER, this.constructor.BRADESCO, this.constructor.DAVIVIENDA, this.constructor.ITAU, this.constructor.MULTIBANCO, this.constructor.IDEAL, this.constructor.PAYU, this.constructor.PSE, this.constructor.POST_FINANCE, this.constructor.SANTANDER, this.constructor.WECHAT, this.constructor.MY_BANK, this.constructor.ALIPAY, this.constructor.PAYSEC_PAYIN, this.constructor.PAYSEC_PAYOUT, this.constructor.EPS, this.constructor.IDEBIT_PAYIN, this.constructor.AFRICAN_MOBILE_SALE, this.constructor.BANCO_DO_BRASIL, this.constructor.APPLE_PAY, this.constructor.RUSSIAN_MOBILE_SALE, this.constructor.PAY_PAl, this.constructor.CASH, this.constructor.PAY_PAl, this.constructor.BALOTO, this.constructor.BANCO_DE_OCCIDENTE, this.constructor.BOLETO, this.constructor.CASH, this.constructor.EFECTY, this.constructor.OXXO, this.constructor.PIX, this.constructor.PAGO_FACIL, this.constructor.REDPAGOS, this.constructor.NARANJA, this.constructor.TARJETA_SHOPPING, this.constructor.AFRICAN_MOBILE_PAYOUT, this.constructor.RUSSIAN_MOBILE_PAYOUT];
      }
    ...
    */
    Types.POST_FINANCE = 'post_finance';
    ...
    */
    ...
    /*
      ...
      the Mobile network operator.
    */
    Types.AFRICAN_MOBILE_PAYOUT = 'african_mobile_payout';
    ...
    */
    Types.RUSSIAN_MOBILE_PAYOUT = 'russian_mobile_payout';
    ...
    */
    Types.TRANSFER_TO_PAYERS = 'transfer_to_payers';
    ...
    */
    Types.BITPAY_PAYOUT = 'bitpay_payout';
