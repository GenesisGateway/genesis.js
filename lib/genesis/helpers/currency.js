  ...
  Currency = class Currency {
    ...
    */
    convertToMinorUnits(amount, currency) {
      var exponent, minor;
      exponent = this.iso4217[currency].exponent;
      minor = new bd.BigDecimal(amount.toString()).scaleByPowerOfTen(exponent).toBigInteger();
    ...
    */
    convertToNominalUnits(amount, currency) {
      var exponent, nominal;
      exponent = this.iso4217[currency].exponent;
      nominal = new bd.BigDecimal(amount).scaleByPowerOfTen(-exponent).setScale(Number(exponent), bd.RoundingMode.DOWN());
      return nominal.toPlainString();
    }

    getCurrencies() {
      return _.compact(_.keys(this.iso4217));
    }
