...
(function() {
  var AxiosApi, Builders, Currency, Domains, Environments, JsonUtils, Promise, Request, Response, Validator, _, https, util;
  ...
  Request = (function() {
    class Request {
      ...
      */
      send() {
        var configValidation, data, params, requestConfig;
        if (!this.isValid()) {
          return Promise.reject(this.getValidationErrorResponse());
        }
        params = this.getArguments();
        configValidation = this.validateConfiguration(params.url.app);
