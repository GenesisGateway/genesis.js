...
Transaction = require path.resolve './src/genesis/transactions/non_financial/kyc/cpf/kyc_cpf'

describe 'KYC CPF Request', ->
  ...
  it 'with proper endpoint url', ->
    assert.equal @transaction.getUrl().path, '/api/v1/cpf/123456'
